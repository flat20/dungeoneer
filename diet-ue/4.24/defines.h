// Force included in make.bat so it's added globally to every .cpp file,
// including the ones in UE4 source.
#pragma once

// Redo generating this

#undef TWOFOUR_API
#undef TWOFOUR_VTABLE
...
#define UE_PROJECT_NAME TwoFour
...
#define TWOFOUR_VTABLE DLLEXPORT_VTABLE
#define TWOFOUR_API DLLEXPORT
